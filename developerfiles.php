...
<?php
  ...
  $sql = "SELECT * FROM developers;"; //selects all the fields from 'prisomers' table
...
<!-- Header -->
  <div class="header1">
    <h1 class="text-center">Developer Files</h1>
  </div>
...
<!-- Button -->
  <div>
    <a class="btn btn-default btn-lg btn-block " href="newbug.php" role="button">Add New Bug </a>
  </div>
